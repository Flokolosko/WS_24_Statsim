...
I want to evaluate, whether the values are also equal to the var calculation method. Thus I define a wrapper and iterate over all data sets and methods. To compare for equality, I use the comparison methods of "==", "all.equal" and "identical"
Code for wrapper
...
We know, that the variance for dataset 2 with excel is very close to the real one if we shift by the mean:  
